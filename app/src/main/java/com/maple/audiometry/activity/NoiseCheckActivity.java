 ...
 * 
 */
public class NoiseCheckActivity extends FragmentActivity implements
		LoginInputListener {
	@ViewInject(R.id.tv_noise_value)
	private TextView tv_noise_value;// 当前噪音值
	@ViewInject(R.id.tv_max_value)
	private TextView tv_max_value;// 最大噪音值
	@ViewInject(R.id.tv_avg_value)
	private TextView tv_avg_value;// 平均噪音值
	@ViewInject(R.id.tv_min_value)
	private TextView tv_min_value;// 最小噪音值
	@ViewInject(R.id.ll_chart_view)
	private LinearLayout ll_chart_view;// 折线图
	@ViewInject(R.id.ll_db_explain)
	private LinearLayout ll_db_explain;// 分贝说明容器
	@ViewInject(R.id.tv_db_explain1)
	private TextView tv_db_explain1;// 分贝说明1
	@ViewInject(R.id.tv_db_explain2)
	private TextView tv_db_explain2;// 分贝说明2
