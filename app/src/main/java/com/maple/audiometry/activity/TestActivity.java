...
public class TestActivity extends FragmentActivity implements OnClickListener,
	...
	private TextView tv_current_hz;// 当前频率
	@ViewInject(R.id.tv_current_db)
	private TextView tv_current_db;// 当前分贝

	@ViewInject(R.id.bt_play)
	private Button bt_play;// 播放
	@ViewInject(R.id.bt_yes)
	private Button bt_yes;// 可听到
	@ViewInject(R.id.bt_no)
	private Button bt_no;// 听不到
